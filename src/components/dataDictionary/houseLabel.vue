<template>
	<div class="houseLabel">
		...
		<el-table :data="tableData"
			...
			<el-table-column prop="bgDataDictValue" label="房源标签名称" show-overflow-tooltip align="center">
			</el-table-column>
		...
		<el-dialog title="新增" v-loading="addLoading" :visible.sync="dialogFormVisible" :show-close="false" @close="resetForm('ruleForm')">
			...
			<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
				<el-form-item label="房源标签名称 : " prop="name">
					<el-input v-model="ruleForm.name" placeholder="请输入房源标签名称"></el-input>
				</el-form-item>
		...
		<el-dialog title="修改" :visible.sync="dialogFormVisible1" v-loading="ediLoading" :show-close="false" @close="resetForm('ruleForm1')">
			...
			<el-form :model="ruleForm1" :rules="rules1" ref="ruleForm1" label-width="150px" class="demo-ruleForm">
				<el-form-item label="房源标签名称 : " prop="name">
					<el-input v-model="ruleForm1.name" placeholder="请输入房源标签名称"></el-input>
				</el-form-item>
				<!--<el-form-item label="是否启用 : " prop="resource">
	...
	export default {
		...
		methods: {
			...
			onSubmit() {
				...
				this.$axios({
					method:'post',
					url:'/houseLabel/findByCondition',
